...
- ebf7f1c: Bump `typescript-go` to `7.1.0-dev.20260730.1` (`37357ae6`, 26 commits) and stop `textDocument/completion` from panicking on unadvertised trigger characters.
